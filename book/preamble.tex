...
\definecolor{softPurple}{HTML}{F1ECFA}
\definecolor{softPurpleLine}{HTML}{9A83C8}
...
\newtcolorbox{objectivesbox}{colback=softPurple,colframe=softPurpleLine,title=Objetivos del capítulo,breakable}
\newtcolorbox{commonmistakesbox}{colback=softRed,colframe=softRedLine,title=Errores comunes,breakable}
\newtcolorbox{readerbox}{colback=softBlue,colframe=softBlueLine,title=Cómo leer este resultado,breakable}
\newtcolorbox{nextbox}{colback=softGreen,colframe=softGreenLine,title=Conexión con el siguiente capítulo,breakable}
...
\newcommand{\chapterstatus}[1]{\begin{summarybox}\textbf{Estado editorial:} #1\end{summarybox}}
